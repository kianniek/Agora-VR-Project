...
namespace TMPro.Examples
{
    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                //_debugMode.Log("Spawning TextMesh Objects.");
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                if (current_Count <= 3)
                {
                    //_debugMode.Log("Fading Counter ... " + current_Count.ToString("f2"));
            ...
            //_debugMode.Log("Done Counting down.");
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                //_debugMode.Log("Current Count:" + current_Count.ToString("f2"));
