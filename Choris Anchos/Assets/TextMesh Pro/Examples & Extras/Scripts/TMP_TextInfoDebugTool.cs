            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //_debugMode.Log("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //_debugMode.Log("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //_debugMode.Log(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
